    ...
    <div class="dashboard-container">
      ...
      <div class="container">
        ...
        <div class="sub-nav hidden-sm hidden-xs">
          <ul>
            <li><a href="" class="heading">Router</a></li>
          </ul>
              ...
              <div class="col-lg-12 col-md-12">
                <div class="widget">
                  ...
                  <div class="widget-body">
                    ...
                    <form class="form-horizontal no-margin" id="frmRouter" method="POST" action="router_form.php">
                      <div class="form-group">
                        <label for="tSiteName" class="col-sm-3 control-label"><strong>Site Name</strong> * </label>
                        <div class="col-sm-7">
                          <input type="text" class="form-control" id="tSiteName" name="tSiteName" value="" placeholder="SiteName">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7">
                          <input type="text" class="form-control" id="tNasidentity" name="tNasidentity" value="" placeholder="NasIdentity">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7">
                          <input type="text" class="form-control" id="tHotspotName" name="tHotspotName" value="" placeholder="Hotspot Server">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7">
                          <input type="text" class="form-control" id="tServer" name="tServer" value="" placeholder="Server">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7">
                          <input type="text" class="form-control" id="tType" name="tType" value="other" placeholder="type" readonly>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7">
                          <input type="text" class="form-control" id="tPorts" name="tPorts" value="1812" placeholder="ports" size="5" maxlength="5" onkeydown="validateNumber(event);">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7">
							...
							<input type="text" class="form-control" id="tSecret" name="tSecret" value="" placeholder="secret">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7">
                          <input type="text" class="form-control" id="tDescription"  name="tDescription" value="" placeholder="Description">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="tGPS1"  name="tGPS1" value="" placeholder="Latitude">
						  <label style="color: #696a6d; margin-top: 10px;" id="lbGPS1"><img src="img/help.png"> ค่าที่ต้้ง-ละติจูด</label>
                        </div>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="tGPS2"  name="tGPS2" value="" placeholder="Longtitude">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7">
                          <input type="text" class="form-control" id="tContact"  name="tContact" value="" placeholder="Contact">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7">
                          <input type="text" class="form-control" id="tPhone"  name="tPhone" value="" placeholder="Phone">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7">
                          <input type="text" class="form-control" id="tEmail" name="tEmail" value="" placeholder="E-mail">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7">
                          ...
                          <input type="checkbox" class="form-control" id="tStatus" value="1"  checked data-toggle="toggle" data-on="On" data-off="Off" data-onstyle="success" data-offstyle="danger" name="tStatus" value="" placeholder="Status">
                      ...
                      <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-10">
                          <button type="submit" class="btn btn-info" name="btnCreate" id="btnCreate">Process</button>
                        </div>
                      </div>
                    </form>
                  </div>
